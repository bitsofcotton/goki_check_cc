...
# Usage
    ...
    python2 test.py ./gokibin (sharpen|bump|penlarge|flarge|represent|jps|tilt|btilt|obj|sbox|prep|presq|nop) <param> input0.png ...
    ...
    python2 test.py senganext gokibin ddpmoptq ddpmoptp <in.png> ... # for large images shrink into small.
