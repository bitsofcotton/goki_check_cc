...
# Usage
    ...
    gokicheck (composite|lenl)  <output.ppm> <input0.ppm> ...
    gokicheck pred  <output.ppm> <noise> <input0.ppm> ...
    ...
    python2 test.py ./gokicheck (cat|catb|catr|catbr|composite|lenl) input0.png input1.png ...
    python2 test.py ./gokicheck pred noise input0.png input1.png ...
