...
# Usage
    ...
    python3 test.py ./gokibin (sharpen|bump|blur|enlarge|shrink|flarge|blink|represent|jps|tilt|obj|sbox|prep|presq|nop|limit|bit|illust|nurie|gray|cleanq|clean[Ll]c?) <param> input0.png ...
    ...
    python3 test.py masp (mprep|mapply|mspecpixel) L.txt img0.ppm ...
    mv `python3 test.py ddpmopt mmovegle img0.ppm ...` dir/
