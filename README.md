...
# Usage
    ...
    gokibin (collect|sharpen|bump|enlarge|denlarge|flarge|blink) <input.ppm> <output.ppm> <recursive_num> <rot_num>
    ...
    python2 test.py ./gokibin (sharpen|bump|enlarge|denlarge|flarge|represent|jps|tilt|obj|sbox|prep|presq|nop) <param> input0.png ...
