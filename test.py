...
if(len(argv) < 4):
...
elif(argv[2] == "pred" or argv[2] == "cat" or argv[2] == "catr" or argv[2] == "composite"):
  ...
  for line in argv[3:]:
    ...
    if(argv[2] == "bump"):
      ...
      subprocess.call([argv[1], "bumpc", str(zratio / 2.), str(rot), str(pixels), str(zratio), root + ".ppm", root + "-" + argv[2] + "0.ppm", root + "-" + argv[2] + ".ppm"])
    elif(argv[2] == "enlarge"):
