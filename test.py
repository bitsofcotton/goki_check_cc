...
if(len(argv) < 4):
  ...
  for line in argv[3:]:
    ...
    if(argv[2] == "bump"):
      ...
      subprocess.call(["convert", root + "-" + argv[2] + "0.ppm", "-blur", "30", "-equalize", "-compress", "none", root + "-" + argv[2] + ".ppm"])
      ...
      subprocess.call(["convert", root + "-" + argv[2] + "0.ppm", "-blur", str(int(pixels)), "-equalize", "-compress", "none", root + "-" + argv[2] + ".ppm"])
