...
if(len(argv) < 4):
  ...
  for line in argv[3:]:
    ...
    if(argv[2] == "bump"):
      ...
      subprocess.call([argv[1], "integ", root + "0.ppm", root + "-" + argv[2] + "1.ppm", str(pixels), str(rot)])
      subprocess.call([argv[1], "bumpc", str(psi / 2.), str(1), str(pixels), str(zratio / 8.), root + ".ppm", root + "-" + argv[2] + "1.ppm", root + "-" + argv[2] + "1.ppm"])
      #subprocess.call([argv[1], "bumpc", str(psi / 2.), str(rot), str(pixels), str(zratio / 8.), root + ".ppm", root + "-" + argv[2] + "1.ppm", root + "-" + argv[2] + "1.ppm"])
      #subprocess.call([argv[1], "integ", root + "2.ppm", root + "-" + argv[2] + ".ppm", str(pixels), str(rot)])
