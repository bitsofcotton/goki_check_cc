...
if(argv[2] == "match" or argv[2] == "matcho"):
  ...
  if(ext1 == ".obj" or ext1 == ".gltf"):
    if(argv[2] == "match"):
      ...
      print argv[5]
      subprocess.call([argv[1], "matcho", argv[5], ".5", "5", "5", root0 + ".ppm", root0 + ".ppm", root0 + "-bump.ppm", argv[4], "match-" + root0 + "-" + argv[4]])
    exit(0)
  elif(ext1 != ".ppm"):
  ...
  if(argv[2] == "match"):
    ...
    print argv[5]
    subprocess.call([argv[1], "matcho", argv[5], ".5", "5", "5", root0 + ".ppm", root1 + ".ppm", root0 + "-bump.ppm", root1 + "-bump.ppm", "match-" + root0 + "-" + root1])
  exit(0)
